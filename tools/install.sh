...
sudo cp -a /usr/lib/arm-linux-gnueabihf/libQt5Qml.so* usr/lib/arm-linux-gnueabihf/
sudo cp -a /usr/lib/arm-linux-gnueabihf/libQt5Quick.so* usr/lib/arm-linux-gnueabihf/
sudo cp -a /usr/lib/arm-linux-gnueabihf/libQt5QmlModels.so* usr/lib/arm-linux-gnueabihf/
sudo cp -a /usr/lib/arm-linux-gnueabihf/libQt5QmlWorkerScript.so* usr/lib/arm-linux-gnueabihf/
sudo cp -a /usr/lib/arm-linux-gnueabihf/libQt5SerialPort.so* usr/lib/arm-linux-gnueabihf/
sync
